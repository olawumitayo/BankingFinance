...
{
    public interface ICounterpartyRepository : IRepository<TblFinanceCounterpartyTransaction>
    {
        IQueryable<TblFinanceCounterpartyTransaction> ValidateCounterparty(int id);
