...
{
    public interface IMultipleFundRepository : IRepository<TblMultipleAccountToCreditFundTransfer>
    {
        IQueryable<TblMultipleAccountToCreditFundTransfer> ValidateMultiple(int accountid);
