...
{
    public class MultipleFundTempRepository : EFRepository<TblMultipleAccountToCreditFundTransferTemp>, IMultipleFundTempRepository
    {
        public MultipleFundTempRepository(TheCoreBankingContext context) : base(context) { }

        public IQueryable<TblMultipleAccountToCreditFundTransferTemp> ValidateMultipleTemp(int accountid)
        {
