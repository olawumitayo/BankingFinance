...
namespace TheCoreBanking.Finance.Data
{
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        /// </summary>
        public TheCoreBankingContext DbContext { get; set; }
        ...
        /// </remarks>
        public virtual T GetRepository<T>(Func<TheCoreBankingContext, object> factory = null) where T : class
        {
        ...
        /// </param>
        /// <returns></returns>
        protected virtual T MakeRepository<T>(Func<TheCoreBankingContext, object> factory, TheCoreBankingContext dbContext)
        {
